...
class Ui_TextMining(object):
    def setupUi(self, TextMining):
        ...
        self.groupBox_4.setMaximumSize(QSize(310, 16777215))
...
"color: #ffffff;")
        ...
        QWidget.setTabOrder(self.endDate, self.inText)
        QWidget.setTabOrder(self.inText, self.exText)
        QWidget.setTabOrder(self.exText, self.category1)
        QWidget.setTabOrder(self.category1, self.category2)
        QWidget.setTabOrder(self.category2, self.category3)
        QWidget.setTabOrder(self.category3, self.saveStat)
        QWidget.setTabOrder(self.saveStat, self.resetFilter)
        QWidget.setTabOrder(self.resetFilter, self.Main)
        QWidget.setTabOrder(self.Main, self.topnCount)
        QWidget.setTabOrder(self.topnCount, self.initTable)
        QWidget.setTabOrder(self.initTable, self.initTF)
        ...
        QWidget.setTabOrder(self.saveNetwork, self.ngram_0)
        QWidget.setTabOrder(self.ngram_0, self.resetOption)
        QWidget.setTabOrder(self.resetOption, self.ngram_1)
        QWidget.setTabOrder(self.ngram_1, self.stopwordsEdit)
        QWidget.setTabOrder(self.stopwordsEdit, self.tabWidget)
        QWidget.setTabOrder(self.tabWidget, self.NLPcheck)
        QWidget.setTabOrder(self.NLPcheck, self.bgcolorPicker)
        QWidget.setTabOrder(self.bgcolorPicker, self.colorPicker)
        QWidget.setTabOrder(self.colorPicker, self.ChangeFont)
        QWidget.setTabOrder(self.ChangeFont, self.initDf)
        QWidget.setTabOrder(self.initDf, self.saveData)
        QWidget.setTabOrder(self.saveData, self.pushButton_3)
