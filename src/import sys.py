...
class TargetLabel(QLabel):
    ...
    def setPixmap(self, image):
        """Reimplement setPixmap() method so that images will appear on objects created from TargetLabel class. Hide other widgets."""
...
class DropTargetEx(QWidget):
    ...
    def setupWidgets(self):
        """Set up the label widget that will display the image after a drop, and the main
 layout."""
    ...
    def dragEnterEvent(self, event):
        """Reimplement event handler to check the data type of an item being dragged onto the widget."""
    ...
    def setImage(self, image_file):
        """Set the label's pixmap when an item is dropped onto the target area."""
